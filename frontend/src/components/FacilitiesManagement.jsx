            ...
            <div className="p-10 space-y-8">
              ...
              <div className="space-y-4 pt-8 border-t border-slate-100">
                ...
                <div
                  ...
                  className={`relative border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center cursor-pointer transition-all ${formData.image ? 'border-blue-300 bg-blue-50/30' : 'border-slate-300 bg-slate-50 hover:bg-slate-100'
